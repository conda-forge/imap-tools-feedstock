...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/imap-tools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/imap-tools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install imap-tools
```
...
It is possible to list all of the versions of `imap-tools` available on your platform:
...
```
pixi search imap-tools --channel conda-forge
```
